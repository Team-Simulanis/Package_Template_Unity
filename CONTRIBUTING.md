...
1. Make an [Issue](https://github.com/Team-Simulanis/Package_template_unity/issues/new)
...
```json
    {
        "dependencies": {
            "com.simulanis.Package_template_unity": "https://github.com/YOUR_USER/Package_template_unity.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at support@simulanis.com.
